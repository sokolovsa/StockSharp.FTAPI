...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class GetGlobalState {
    ...
    static GetGlobalState() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "AigEUgZ1c2VySUQimAQKA1MyQxIaCghtYXJrZXRISxgBIAIoBVIIbWFya2V0", 
            ...
            "dFVTRnV0dXJlGA8gASgFUg5tYXJrZXRVU0Z1dHVyZRIeCgpxb3RMb2dpbmVk", 
            "GAYgAigIUgpxb3RMb2dpbmVkEh4KCnRyZExvZ2luZWQYByACKAhSCnRyZExv", 
            "Z2luZWQSHAoJc2VydmVyVmVyGAggAigFUglzZXJ2ZXJWZXISJAoNc2VydmVy", 
            "QnVpbGRObxgJIAIoBVINc2VydmVyQnVpbGRObxISCgR0aW1lGAogAigDUgR0", 
            "aW1lEhwKCWxvY2FsVGltZRgLIAEoAVIJbG9jYWxUaW1lEjsKDXByb2dyYW1T", 
            "dGF0dXMYDCABKAsyFS5Db21tb24uUHJvZ3JhbVN0YXR1c1INcHJvZ3JhbVN0", 
            "YXR1cxIiCgxxb3RTdnJJcEFkZHIYDSABKAlSDHFvdFN2cklwQWRkchIiCgx0", 
            "cmRTdnJJcEFkZHIYDiABKAlSDHRyZFN2cklwQWRkchIWCgZjb25uSUQYECAB", 
            "KARSBmNvbm5JRCIwCgdSZXF1ZXN0EiUKA2MycxgBIAIoCzITLkdldEdsb2Jh", 
            "bFN0YXRlLkMyU1IDYzJzIoMBCghSZXNwb25zZRIeCgdyZXRUeXBlGAEgAigF", 
            "OgQtNDAwUgdyZXRUeXBlEhYKBnJldE1zZxgCIAEoCVIGcmV0TXNnEhgKB2Vy", 
            "ckNvZGUYAyABKAVSB2VyckNvZGUSJQoDczJjGAQgASgLMhMuR2V0R2xvYmFs", 
            "U3RhdGUuUzJDUgNzMmNCRQoTY29tLmZ1dHUub3BlbmFwaS5wYlouZ2l0aHVi", 
          "LmNvbS9mdXR1b3Blbi9mdGFwaTRnby9wYi9nZXRnbG9iYWxzdGF0ZQ=="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_GetGlobalState_S2C__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.GetGlobalState.S2C, global::Futu.OpenApi.Pb.GetGlobalState.S2C.Builder>(internal__static_GetGlobalState_S2C__Descriptor,
                new string[] { "MarketHK", "MarketUS", "MarketSH", "MarketSZ", "MarketHKFuture", "MarketUSFuture", "QotLogined", "TrdLogined", "ServerVer", "ServerBuildNo", "Time", "LocalTime", "ProgramStatus", "QotSvrIpAddr", "TrdSvrIpAddr", "ConnID", });
    ...
    public sealed partial class S2C : pb::GeneratedMessage<S2C, S2C.Builder> {
      ...
      private static readonly string[] _s2CFieldNames = new string[] { "connID", "localTime", "marketHK", "marketHKFuture", "marketSH", "marketSZ", "marketUS", "marketUSFuture", "programStatus", "qotLogined", "qotSvrIpAddr", "serverBuildNo", "serverVer", "time", "trdLogined", "trdSvrIpAddr" };
      private static readonly uint[] _s2CFieldTags = new uint[] { 128, 89, 8, 40, 24, 32, 16, 120, 98, 48, 106, 72, 64, 80, 56, 114 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasMarketUS) {
          output.WriteInt32(2, field_names[6], MarketUS);
        }
        if (hasMarketSH) {
          output.WriteInt32(3, field_names[4], MarketSH);
        }
        if (hasMarketSZ) {
          output.WriteInt32(4, field_names[5], MarketSZ);
        }
        if (hasMarketHKFuture) {
          output.WriteInt32(5, field_names[3], MarketHKFuture);
        }
        if (hasQotLogined) {
          output.WriteBool(6, field_names[9], QotLogined);
        }
        if (hasTrdLogined) {
          output.WriteBool(7, field_names[14], TrdLogined);
        }
        if (hasServerVer) {
          output.WriteInt32(8, field_names[12], ServerVer);
        }
        if (hasServerBuildNo) {
          output.WriteInt32(9, field_names[11], ServerBuildNo);
        }
        if (hasTime) {
          output.WriteInt64(10, field_names[13], Time);
        }
        if (hasLocalTime) {
          output.WriteDouble(11, field_names[1], LocalTime);
        }
        if (hasProgramStatus) {
          output.WriteMessage(12, field_names[8], ProgramStatus);
        }
        if (hasQotSvrIpAddr) {
          output.WriteString(13, field_names[10], QotSvrIpAddr);
        }
        if (hasTrdSvrIpAddr) {
          output.WriteString(14, field_names[15], TrdSvrIpAddr);
        }
        if (hasMarketUSFuture) {
          output.WriteInt32(15, field_names[7], MarketUSFuture);
        }
        if (hasConnID) {
